...
```mermaid
graph TD
  d2826cca["ERC-721 NFT"]
  253ad594["Frontend"]
  e9f5d128["Wallet Auth"]
  d2826cca --> 253ad594
  253ad594 --> e9f5d128
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--d2826cca.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--253ad594.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--e9f5d128.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--d2826cca.md)
- [Frontend](.nskills/components/frontend-scaffold--253ad594.md)
- [Wallet Auth](.nskills/components/wallet-auth--e9f5d128.md)
